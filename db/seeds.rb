shops = Shop.create([{ name: 'ベーカリー', address: '東京都港区南麻布１丁目',telephone: '08012345678',image: 'ベーカリー.jpg' }, 
...
categories = Category.create([{ name: 'パン' }, 
  { name: '飲み物' }])

foods = Food.create!([{ name: 'クロワッサン', price: 250,category_id: 1,image:'クロワッサン.jpg',shop_id: 1 }, 
